...
date: 2022-10-13
description: We demonstrate how, through the development of uniquely-adaptive searchable regions, existing methods can help to further improve the robustness of Deep Learning models, and also make the existing methods applicable to non-image related tasks by providing an upper bound for discovering adversarial examples.
event: AISB Workshop on Explainability and Transparency in AI
event_url: http://va7.myqnapcloud.com/WordPress/xtai-2022/
location: Swansea University, United Kingdom
categories: [workshop, presentation]
image: feature.png
---

<embed src="presentation.pdf" width="700" height="500" type="application/pdf">

## Abstract

Talk prepared for the [AISB Workshop on Explainability and Transparency in AI, XTAI 2022](http://va7.myqnapcloud.com/WordPress/xtai-2022/).
